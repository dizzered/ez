...
$this->params['breadcrumbs'][] = Yii::$app->name.' '.$this->title;
?>

<div class="site-page container">

    <h1 class="page-title" style="text-align: left;"><?= Yii::$app->name.' '.$this->title ?></h1>
    ...
    <p>Google, as a third party vendor, uses cookies to serve ads on your site.
    ...
    <p>
        <?= Yii::$app->request->getHostInfo() ?><br />
        10871 Bustleton Ave <br />
        Philadelphia, PA 19116<br /><br />
