...
<div class="firm-form">
    ...
    <?php
    if ($model->image) {
        echo '<div class="form-group">'.Html::img('/uploads/firm/thumb_'.$model->image, ['class' => 'img-thumbnail', 'style' => 'width:200px; vertical-align: text-top;']).'</div>';
    }
    ?>
    ...
    <div class="form-group">
        ...
        <?= !$model->isNewRecord ? Html::a('<span class="glyphicon glyphicon-trash"></span> Delete', ['/admin/firm/delete?id='.$model->id], ['class' => 'btn btn-danger', 'data-confirm' => 'Are you sure you want to delete?']) : '' ?>
    </div>
