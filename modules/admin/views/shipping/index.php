...
<div class="firm-index">
    ...
    <div class="pull-right" style="margin-top: 20px;"><?= Html::a('<span class="glyphicon glyphicon-plus"></span> Add New', ['/admin/shipping/create'], ['class' => 'btn btn-success btn-md'])?></div>
    ...
    <?= DynaGrid::widget([
        'gridOptions' => [
            ...
            'toolbar' =>  [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-refresh"></i>', ['/admin/shipping'], ['data-pjax'=>0, 'class' => 'btn btn-primary', 'title'=>'Reset data'])
                ],
        ...
        'columns' => [
            ...
            [
                ...
                'content' => function($model) {
                    $image = $model->image ? '/uploads/shipping/thumb_'.$model->image : '/img/noimage.png';
